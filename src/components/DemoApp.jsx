...
import { renderEventContent, renderSidebarEvent } from '../utils/render-utils';
import { useEffect } from 'react';
import { blueGrey, brown, deepOrange, lightBlue, lightGreen, pink } from '@mui/material/colors';

// I need toadd events to calendar through CMS
// Create array of colors for event bar to be - does the CMS have dropdowns?
// make the calendar display only
//remove the add/delete buttons - do this after all other functionality is straight


const DemoApp = () => {
  const bckgrndClr = ['red', 'lightBlue', 'blueGrey', 'pink', 'deepOrange', 'lightGreen']
...
//when events is brought in as prop, you can use events.lngth logic for colors
  let events = [{
    id: createEventId(),
    title: 'oopu',
...
// class="fc-scrollgrid  fc-scrollgrid-liquid" height: 75vh;
